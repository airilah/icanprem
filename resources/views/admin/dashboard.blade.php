      ...
      <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-xxl-3 col-md-6">
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Pendaftar <span>| Tahun ini</span></h5>
        ...
        <div class="col-lg-8">
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Laporan Grafik <span>/Tahun ini</span></h5>
        ...
        <div class="col-lg-4">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <a href="/paket"><h5 class="card-title">Stok Paket <span>| Hari Ini</span></h5></a>
