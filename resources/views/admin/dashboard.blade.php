      ...
      <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <div class="col-12">
                <div class="card top-selling overflow-auto">
                    <div class="card-body">
                    <a href="/daftar_antrian"><h5 class="card-title">Tabel Antrian <span>| Semua</span></h5></a>
            ...
            <div class="col-12">
                <div class="card top-selling overflow-auto">
                    <div class="card-body">
                    <a href="/penjualan"><h5 class="card-title">Tabel Penjualan <span>| Semua</span></h5></a>
        ...
        <div class="col-lg-4">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <a href="/paket"><h5 class="card-title">Stok Paket <span>| Semua</span></h5></a>
